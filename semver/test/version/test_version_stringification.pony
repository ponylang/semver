...
class \nodoc\ TestVersionStringification is UnitTest
  fun name(): String =>
  ...
  fun apply(h: TestHelper) =>
    ...
    let v5 =
      Version(
        where major' = 5,
        pr_fields' = ["alpha"; 0; "beta"],
        build_fields' =
          ["buildinfo"; "morebuildinfo"])
    h.assert_eq[String](
      "5.0.0", v5.major_minor_patch_string())
    h.assert_eq[String](
      "alpha.0.beta", v5.pre_release_string())
    h.assert_eq[String](
      "buildinfo.morebuildinfo",
      v5.build_string())
    h.assert_eq[String](
